...
#CHEBI2INCHI_URL = 'http://ftp.ebi.ac.uk/pub/databases/chebi/Flat_file_tab_delimited/chebiId_inchi.tsv'
...
ECOLI_JSON_FNAME = os.path.join(DATA_DIR, 'iNJ661.json')
ECOLI_SBML_FNAME = os.path.join(DATA_DIR, 'iNJ661.xml')
